'''
Pong game taken from ClearCode, full credit goes to him (https://www.youtube.com/watch?v=Qf3-aDXG8q4; https://github.com/clear-code-projects/Pong_in_Pygame)

I'm not great at game dev, don't judge me xD
'''
